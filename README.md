...
- `iter_read_cache_dirs()`, `find_cached_file()` and `get_write_cache_dir()`: convenience functions to get the cache path for a A*V package, checking `ScopeSim_Data` first.
